...
public class Staircase {
	...
	public class Flight {
		...
		public void setAllSteps(Step step) {
		...
		public void setStep(Step step, int stepindex) {
	...
	public class Step {
		...
		double nosing = 0;
		double gap = 0;
		Curtail curtail = null;
		public Step() {
			this.going = bCode.maxGoing;
			this.rising = bCode.maxRising;
			this.height = 3;
			this.width = bCode.minWidth;
			this.nosing = 3;
			this.gap = 0;
			this.curtail = null;
		}
	...
	public Staircase(BuildingCode bCode, double rise) {
		...
		for (int i = 0; i < minFlights; i++) {
			...
			flight.run= landingsRequired[i] ? stepsPerFlight[i]*step.going + bCode.minLandingLength: stepsPerFlight[i]*step.going ;
			...
			if(landingsRequired[i]) {				
				...
				flight.landing.length=bCode.minLandingLength;
	...
	public void setAllSteps(Step step) {
		...
		for (int i = 0; i < flights.size(); i++) {
			List<Step> steps = flights.get(i).steps;
